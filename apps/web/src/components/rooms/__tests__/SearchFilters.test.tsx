...
describe('SearchFilters', () => {
  it('renders all filter inputs and search button', () => {
    render(<SearchFilters params={defaultParams} loading={false} onParamChange={vi.fn()} onSearch={vi.fn()} />);
  ...
  it('calls onParamChange with capacity as Number when changed', () => {
    ...
    render(<SearchFilters params={defaultParams} loading={false} onParamChange={onParamChange} onSearch={vi.fn()} />);
  ...
  it('calls onSearch when Search button is clicked', () => {
    ...
    render(<SearchFilters params={defaultParams} loading={false} onParamChange={vi.fn()} onSearch={onSearch} />);
  ...
  it('Search button is disabled and shows loading when loading=true', () => {
    render(<SearchFilters params={defaultParams} loading={true} onParamChange={vi.fn()} onSearch={vi.fn()} />);
