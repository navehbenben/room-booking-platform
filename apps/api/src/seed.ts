...
const TIMEZONES = [
  ...
  'Europe/Rome', 'Europe/Berlin', 'Europe/Amsterdam', 'Europe/Madrid',
  'Europe/Warsaw', 'Europe/Helsinki', 'Europe/Athens', 'Europe/Moscow',
  'Asia/Dubai', 'Asia/Kolkata', 'Asia/Bangkok', 'Asia/Singapore',
  'Asia/Tokyo', 'Asia/Seoul', 'Asia/Shanghai', 'Australia/Sydney', 'Pacific/Auckland',
];

const ALL_FEATURES = [
  'projector', 'whiteboard', 'tv', 'video_conf', 'phone',
  'standing_desk', 'natural_light', 'ac', 'webcam', 'soundproof',
  'lounge_seating', 'dual_screen',
];
...
const ROOM_TYPES: Record<number, string> = {
  2: 'Focus Pod', 4: 'Small Meeting Room', 6: 'Collaboration Room',
  8: 'Conference Room', 10: 'Conference Room', 12: 'Large Meeting Room',
  14: 'Large Meeting Room', 16: 'Board Room', 20: 'Training Room',
  24: 'Event Space', 30: 'Auditorium',
};
...
function generateRooms(
  ...
  for (let i = 0; i < count; i++) {
    ...
    rooms.push({ name, capacity, timezone, features, images: generateImages(name), description: generateDescription({ name, capacity, features }) });
  }
  return rooms;
}
